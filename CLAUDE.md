...
**指標①articles面クリック構成比 15%以上 / ②`/articles/`宛のDofollow DR30以上 +2件 / ③9月単月報酬 15,000円** の3点で判定する。**9月末に数値を見てからの指標変更・閾値調整は禁止**。中間測定は 8/31（記録のみ）。判定ルール・基準線・交絡要因の全文 → `management/_metrics/GATE_20260930.md`
